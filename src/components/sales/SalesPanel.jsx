...
const SalesPanel = ({ mode, isDark, onAdd, title: customTitle, description: customDescription, voucherType = "sales", emptyText, icon: CustomIcon }) => {
  ...
  return (
    ...
    >
      {isLoading && (
        <div
          className="absolute inset-0 z-50 flex items-center justify-center rounded-xl backdrop-blur-md"
          ...
          <div className="flex flex-col items-center gap-3 px-5 py-4 rounded-xl glass-surface">
            <div className="relative h-10 w-10 flex items-center justify-center">
              <div
                ...
                style={{ borderColor: 'var(--app-accent-soft)', borderTopColor: 'var(--app-accent)' }}
              />
              <Bot size={16} style={{ color: 'var(--app-accent)' }} />
            </div>
            <span
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            >
              ...
              <span
                ...
                style={{
                  background: excelMode ? 'var(--app-accent-gradient)' : 'var(--app-border)',
                }}
              >
                <motion.span
                  layout
...
const TableHead = ({ label, sortable, center, width, borderRight }) => (
  <th
    className={`px-3 py-2.5 border-b text-[10.5px] font-semibold uppercase tracking-wider ${center ? 'text-center' : 'text-left'} ${borderRight ? 'border-r' : ''}`}
    style={{ borderColor: 'var(--app-row-border)', color: 'var(--app-muted)', width: width, backgroundColor: 'var(--app-table-head-bg)' }}
  >
