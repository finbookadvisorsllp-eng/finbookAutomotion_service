...
import { Save, Send, ArrowLeft, Plus, Settings, ChevronDown, CheckCircle2, ChevronUp, Trash2, Calendar, Layout, Search, ArrowDownLeft } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto space-y-4">
          ...
          <div className="rounded-xl border shadow-sm overflow-hidden" style={{ borderColor: theme.border, backgroundColor: theme.panel }}>
            ...
            <div className="p-4 flex flex-wrap gap-4">
              <InputField label="Voucher No." placeholder="REC-2026-001" />
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody>
                  <tr className="border-t" style={{ borderColor: theme.border }}>
                    <td className="py-2 text-[11px] font-semibold" style={{ color: theme.text }}>Cr</td>
                    <td className="py-2"><InputField placeholder="Select Ledger (e.g., Customer, Interest)..." /></td>
