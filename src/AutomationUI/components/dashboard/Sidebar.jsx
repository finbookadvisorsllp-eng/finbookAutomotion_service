...
const menuItems = [
  ...
  { key: 'Sales', icon: BarChart3, children: ['Sales Inbox', 'Sales Review', 'Sales Archive', 'Sales Order', 'Sales Invoice', 'Credit Note (Sales Return)'] },
  { key: 'Purchase/Expense', icon: ShoppingCart, children: ['Purchase Inbox', 'Purchase Review', 'Purchase Archive', 'Purchase Order', 'Purchase Invoice — With Inventory', 'Purchase Invoice — Without Inventory', 'Debit Note (Purchase Return)'] },
  { key: 'Petty Cash', icon: Wallet, children: ['Petty Cash Inbox', 'Petty Cash Review', 'Petty Cash Archive', 'Payment Voucher', 'Receipt Voucher'] },
