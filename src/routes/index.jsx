...
const InvoiceInbox = lazy(() => import('../components/invoicing/InvoiceInbox'))
const CreateInvoice = lazy(() => import('../components/invoicing/CreateInvoice'))
...
const InvoiceInboxRoute = () => { const { isDark, navigate } = useDashCtx(); return <InvoiceInbox isDark={isDark} onAdd={() => navigate('/invoices/new')} /> }
const CreateInvoiceRoute = () => { const { isDark, navigate } = useDashCtx(); return <CreateInvoice isDark={isDark} onBack={() => navigate('/invoices')} /> }
...
export const router = createBrowserRouter([
  { path: '/login', element: <Login /> },
  {
    ...
    children: [
      ...
      { path: 'invoices', element: <InvoiceInboxRoute /> },
      { path: 'invoices/new', element: <CreateInvoiceRoute /> },
