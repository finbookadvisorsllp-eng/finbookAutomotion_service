...
export default function Level5StockItemCustomer({ customerId, currentYearData }) {
  ...
  return (
    <div className="animate-fade-in flex flex-col gap-2">
      ...
      <div className="flex items-center justify-between mb-4 bg-white dark:bg-slate-800 p-2 px-3 rounded-xl shadow-sm border border-slate-300 dark:border-slate-600">
        ...
        {/* Date Selector */}
        <div className="flex items-center bg-transparent border border-slate-200 dark:border-slate-700 rounded-lg h-8">
          <button className="px-2 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors border-r border-slate-200 dark:border-slate-700 h-full flex items-center">
          ...
          <button className="px-2 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors border-l border-slate-200 dark:border-slate-700 h-full flex items-center">
