...
export default function Level2LedgerBreakdown({ groupData }) {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden shadow-sm animate-fade-in">
      <div className="p-5 border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 flex justify-between items-center">
        <div>
          <h2 className="text-lg font-bold text-slate-800 dark:text-white">{groupData.name}</h2>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Ledger Breakdown</p>
        </div>
