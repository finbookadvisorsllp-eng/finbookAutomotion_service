...
export default function TrialBalance() {
 ...
 <button className="text-slate-800 hover:bg-slate-100 p-1 rounded-lg transition-colors">
 ...
 {/* View PDF Button */}
 <button className="flex items-center gap-1.5 px-3 h-9 glass-card border border-slate-200 rounded-lg text-[13px] font-bold text-slate-800 hover:bg-slate-200 transition-colors">
 ...
 {/* Parent Row */}
 <tr
 className={`transition-colors group ${row.isExpandable ? 'cursor-pointer hover:bg-slate-200 ' : 'hover:bg-slate-50 '}`}
 ...
 <td className="px-4 py-2 text-[13px] font-medium text-slate-700 text-right pointer-events-none">
 {formatINR(row.debit)}
 </td>
 <td className="px-4 py-2 text-[13px] font-medium text-slate-700 text-right tabular-nums pointer-events-none">
 ...
 <td className="px-4 py-2 text-[13px] font-medium text-slate-700 text-right">
 ...
 <td className="px-4 font-black text-[13px] text-slate-900 ">
 Total
 </td>
 <td className="px-4 text-right font-black text-[13px] text-slate-900 ">
