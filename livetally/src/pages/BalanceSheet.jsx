  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3.5 mb-5">
        {[
          { label: 'Total Assets',    value: totalAssets,      bg: 'bg-blue-50',    border: 'border-blue-100',   color: 'text-blue-700' },
          { label: 'Current Assets',  value: totalCurrentAssets, bg: 'bg-sky-50',  border: 'border-sky-100',    color: 'text-sky-700' },
          { label: 'Total Liabilities', value: totalCurrentLiab, bg: 'bg-red-50', border: 'border-red-100',    color: 'text-red-600' },
          { label: "Owner's Equity",  value: totalOwnersFunds,  bg: 'bg-emerald-50',border: 'border-emerald-100',color: 'text-emerald-700' },
        ].map(s => (
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 mb-5">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-5">
          ...
          <Section title="Current Assets" data={balanceSheet.assets.currentAssets} valueColor="text-blue-700" totalLabel="Total Current Assets" total={totalCurrentAssets} />
          <Section title="Fixed Assets" data={balanceSheet.assets.fixedAssets} valueColor="text-purple-700" totalLabel="Total Fixed Assets" total={totalFixedAssets} />
          <div className="flex items-center justify-between py-3 bg-blue-600 text-white px-4 rounded-xl">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-5">
          ...
          <Section title="Current Liabilities" data={balanceSheet.liabilities.currentLiabilities} valueColor="text-red-600" totalLabel="Total Current Liabilities" total={totalCurrentLiab} />
          <Section title="Owner's Funds" data={balanceSheet.liabilities.ownersFunds} valueColor="text-emerald-700" totalLabel="Total Owner's Funds" total={totalOwnersFunds} />
          <div className="flex items-center justify-between py-3 bg-slate-800 text-white px-4 rounded-xl">
