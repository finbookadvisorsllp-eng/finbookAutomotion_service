                ...
                <tbody>
                  {(form.productLines || []).map((row) => (
                    <tr key={row.id} className="animate-in fade-in slide-in-from-left-2 duration-300">
                      ...
                      <td className="px-2"><SearchableDropdown placeholder="Taxable" value={row.taxabilityType || 'Taxable'} compact options={['Taxable', 'Exempt']} onChange={(val) => updateProductLine(row.id, { taxabilityType: val })} /></td>
