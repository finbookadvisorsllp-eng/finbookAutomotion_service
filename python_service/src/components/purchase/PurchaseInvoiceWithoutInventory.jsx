...
const PurchaseInvoiceWithoutInventory = ({ isDark, onBack }) => {
  const theme = {
      ...
      <div className="flex items-center justify-between px-4 py-2 border-b shrink-0 bg-white/50 backdrop-blur-sm" style={{ borderColor: theme.border }}>
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-[14px] font-black tracking-tight" style={{ color: theme.text }}>Purchase Invoice (Accounting)</h1>
          </div>
        </div>
      </div>
...
export default PurchaseInvoiceWithoutInventory;
